...
void loop() {
      ...
      if (currentMillis - previousMillis >= 10) {  // start timed event    
          ...
          Serial.print(" , ");
          Serial.print(LLRFiltered);
          Serial.println();   
          

          servo1Out = map(LLRFiltered,-255,255,180,0);
          servo2Out = map(LLRFiltered,-255,255,0,180);

          servo1.write(servo1Out-5);
          servo2.write(servo2Out+5);          
